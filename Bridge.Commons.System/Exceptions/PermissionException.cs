...
namespace Bridge.Commons.System.Exceptions
{
    ...
    public class PermissionException : BaseException
    {
        ...
        public PermissionException(Exception innerException) : base(innerException)
        {
        }
        ...
        /// <param name="innerException"></param>
        public PermissionException(int code, string message, string field = null, Exception innerException = null)
        ...
        /// <param name="message"></param>
        /// <param name="innerException"></param>
        public PermissionException(string message, Exception innerException = null)
        ...
        /// <param name="innerException"></param>
        public PermissionException(IList<ErrorInstance> errorList, Exception innerException = null)
